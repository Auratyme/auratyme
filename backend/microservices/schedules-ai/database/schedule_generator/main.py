...
def save_comparison(comparison_df: pd.DataFrame, filename: str):
    ...
    if not comparison_df.empty:
        ...
        print(f"Comparison saved to file '{filename}'.")
    else:
        print(
            f"File '{filename}' was not saved because the DataFrame is empty."
        )
...
def main():
    ...
    try:
        ...
        data_loader.load_activity_categories()
        ...
        print("\nComparison of generated schedules with schedule_dataset_males_2010 data:")
        ...
        print(
            "\nSchedule generation completed. Files have been saved in the 'output' folder."
        )
