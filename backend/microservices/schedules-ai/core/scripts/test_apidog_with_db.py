...
and verifies that the database integration works correctly. It performs CRUD
operations on the database to ensure proper functionality.
"""
...
async def test_db_connection():
    ...
    Attempts to initialize the database connection pool and create tables.
...
async def test_save_schedule():
    ...
    Creates a new schedule with random IDs and saves it to the database.

    Returns:
        str: The ID of the saved schedule if successful, None otherwise.
    """
...
async def test_get_schedule(schedule_id):
    ...
    Retrieves a schedule with the specified ID from the database and displays its data.

    Args:
        schedule_id: The ID of the schedule to retrieve.

    Returns:
        bool: True if the schedule was found and retrieved, False otherwise.
    """
...
async def test_list_schedules():
    ...
    Retrieves a list of all schedules from the database and displays them.
...
async def test_get_latest_schedule():
    ...
    Retrieves the most recently created schedule from the database and displays its data.

    Returns:
        bool: True if a schedule was found and retrieved, False otherwise.
    """
...
async def main():
    ...
    Executes all test functions in sequence, with proper error handling
    and dependency management between tests.
    """
